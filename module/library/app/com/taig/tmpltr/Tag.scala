...
abstract class Tag[T <: Tag[T]] protected(tag: String, attributes: Attributes = Attributes.empty, content: Content = Txt.empty, minimizeEmpty: Boolean = true) extends HtmlNode[T](
...
object Tag
{
	...
	object Head
	{
		...
		abstract class Style[S <: Style[S]](attributes: Attributes)(content: Txt) extends Tag[S]( "style", attributes, content )

		abstract class Title[T <: Title[T]](attributes: Attributes)(content: Txt) extends Tag[T]( "title", attributes, content )
	}
	...
	object Body
	{
		...
		object Form
		{
			...
			abstract class TextArea[T <: TextArea[T]](attributes: Attributes)(content: Txt) extends Tag[T]( "textarea", attributes, content )
		}
	...
	abstract class Script[S <: Script[S]](attributes: Attributes)(content: Txt) extends Tag[S]( "script", attributes, content, false )
	object Script
	{
